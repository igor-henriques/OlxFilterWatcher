...
public sealed class OlxVehiclePostService : IOlxVehiclePostService
{
	...
	public async Task AddAsync(OlxVehiclePostDTO olxPostDTO, CancellationToken cancellationToken = default)
	{
